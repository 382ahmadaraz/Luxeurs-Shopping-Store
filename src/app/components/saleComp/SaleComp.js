...
import { sales } from "./saleProduct/SaleProduct";
  ...
  <div className=" flex flex-wrap justify-start pl-6 xs:pl-9 2xl:w-[80rem] m-auto gap-3 sm:gap-5 lg:gap-3 xl:gap-7  font-outfit">
    ...
    {sales.map((items) => {
      return (
        <Link
          key={items.slug}
          href={`/collections/sale/details/${items.slug}`} className=" w-[45%] h-fit xs:w-[45%] xs:h-[25%] sm:w-[45%] md:w-[30%] lg:w-[23%] xl:w-[22%] xl:h-fit">
