...
import { cards } from "../../components/mansWearComp/mensData/MensData"
      ...
      return (
        <Link
          ...
          <div key={items} className="w-[100%] h-[100%]  group">
            <div className="h-[15rem] xs:h-[20rem] sm:h-[25rem] lg:h-[20rem] xl:h-[24rem] w-[100%] cursor-pointer ">
            ...
            <div className="flex flex-col sm:gap-2 items-center xs:py-2 sm:py-4 text-center text-zinc-900 ">
              ...
              <div className="flex gap-1 text-md text-[10px] sm:text-md xl:text-lg">
